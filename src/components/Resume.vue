  ...
  <b-container fluid id="about">
    <b-row class="page-content">
      <b-col>
        ...
        <h4 id="-education-" class="underline mt-2">
          <strong>EDUCATION</strong>
        </h4>
        <h5 id="-bachelor-of-science-major-in-computer-science-co-op-_2011-2012-2016-present_">
        ...
        <h4 id="-work-experience-" class="underline">
        ...
        <p>
          ...
          <br />
          <em>As a part of the Integrated Application Services team in the Information Systems Branch, my team worked on modernizing a web application for internal project management.</em>
        </p>
        <ul>
        ...
        <h4 id="-academic-project-" class="underline">
        ...
        <h5 id="-vice-president-cssa-computer-science-students-association-_march-2019-present_">
          <strong>Vice President, CSSA (Computer Science Students’ Association)</strong> -
          <em>March 2019-Present</em>
        </h5>
        <ul>
          <li>Coordinates with a team to plan and host events (e.g. CSSA Game Jam, CS Mixer, etc.).</li>
          <li>Built a prototype website for the CSSA using Vue.js and Bootstrap-Vue</li>
        </ul>
